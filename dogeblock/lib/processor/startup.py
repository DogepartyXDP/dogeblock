...
from dogeblock.lib import blockfeed, blockchain, config, cache, database, util
from dogeblock.lib.processor import StartUpProcessor, CORE_FIRST_PRIORITY, CORE_LAST_PRIORITY, api, start_task
...
def start_dp_blockfeed():
    logger.info("Starting up dogeparty block feed poller...")
    start_task(blockfeed.process_dp_blockfeed)
