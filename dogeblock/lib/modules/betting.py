"""
Implements dogewallet enhanced asset info and betting feed support as a dogeblock plugin
...
from dogeblock.lib.modules import BETTING_PRIORITY_PARSE_BROADCAST
